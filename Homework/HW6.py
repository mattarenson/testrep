...
def evalF(x): 
    ...
    F[1] = (1-x[0])**(1/4)+x[1]+.05*x[2]**2-.15*x[2]-1
...
def evalJ(x): 
    ...
    J = np.array([[1-x[0]*x[1]*math.sin(x[0]*x[1]*x[2]), -x[0]*x[2]*math.sin(x[0]*x[1]*x[2]), -x[0]*x[1]*math.sin(x[0]*x[1]*x[2])], 
        [-(1/4)*(1-x[0])**(-3/4), 1, .1*x[2]-.15], 
        [-2*x[0], -.2*x[1]+.01, 1]])
    return J
